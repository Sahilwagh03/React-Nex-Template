        ...
        <div className='flex flex-col px-4 py-2 max-w-[600px] justify-items-end pb-16'>
            <div className='flex flex-col gap-4 p-5 pb-4 justify-items-end'>
                ...
                <p className='text-sm md:text-md text-[#aaa8a8]'>
                    &quot;One of my favorite features is the ability to create customized routines. I&apos;ve set up a &apos;Good Morning&apos; routine that gradually turns on the lights and adjusts the thermostat to the perfect temperature to wake me up gently. And in the evening, the &apos;Goodnight&apos; routine ensures that all the lights are off and the doors are locked without me having to check each one individually&quot;.
                </p>
