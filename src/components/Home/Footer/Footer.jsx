...
const Footer = () => {
    ...
    return (
        <section className='pb-12 px-12'>
            <footer>
                <div className='grid grid-cols-[1fr_2fr_0.6fr]'>
                    ...
                    <div className='h-36 flex flex-row justify-between gap-5'>
                        {
                            footerItems.map(({ footerLinks, footerNavLabel }, index) => (
                                <FooterNavItems footerLinks={footerLinks} footerNavLabel={footerNavLabel} key={index} />
                            ))
                        }
                    </div>
                    <div className='h-36 flex flex-col items-end justify-between'>
                ...
                <div className="text-center md:text-left font-medium text-[0.9rem] mt-10 items-center flex flex-row justify-between">
