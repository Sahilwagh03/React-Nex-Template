    ...
    const featuresData = [
        {
            ...
            component:
                <div className='absolute right-0 bottom-0'>
                    <Image src='/card_img.png' width={100} height={100} className='w-[11rem] lg:w-80 h-auto' />
                </div>
        },
        {
            ...
            component:
                <div className='absolute right-0 bottom-0'>
                    <Image src='/expeness.png' width={100} height={100} className='w-[10rem] lg:w-64 h-auto' />
                </div>
        },
        {
            ...
            component:
                <div className='absolute right-0 bottom-0'>
                    <Image src='/payable.png' width={100} height={100} className='w-[11rem]  lg:w-80 h-auto' />
                </div>
        },
        {
            ...
            component:
                <div className='absolute right-0 bottom-0'>
                    <Image src='/automation.png' width={100} height={100} className='w-[10rem] lg:w-80 h-auto' />
                </div>
        },
    ]
    return (
